  ...
  opa_eval:
    ...
    - name: Evaluate OPA Policy w/tags
      ...
      with:
        ...
        policy: ./examples/json/tags.json #path to tags file
    ...
    - name: Evaluate OPA Policy w/addr_obj
      ...
      with:
        tests: ./validate/opa/panos.rego
        policy: ./examples/json/addr_obj.json #path to address objects file
    ...
    - name: Evaluate OPA Policy w/addr_group
      ...
      with:
        tests: ./validate/opa/panos.rego
        policy: ./examples/json/addr_group.json #path to address groups file
    ...
    - name: Evaluate OPA Policy w/NAT
      ...
      with:
        tests: ./validate/opa/panos.rego
        policy: ./examples/json/nat.json #path to nat security policy file
    ...
    - name: Evaluate OPA Policy w/sec_ex
      ...
      with:
        tests: ./validate/opa/panos.rego
        policy: ./examples/json/sec_policy.json #path to security policy file
    ...
    - name: Evaluate OPA Policy w/sevices
      ...
      with:
        tests: ./validate/opa/panos.rego
        policy: ./examples/json/services.json #path to services file
